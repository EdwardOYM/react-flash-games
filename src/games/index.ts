export type GameDefinition = {
  id: string
  titleKey: 'games.orbit' | 'games.signal' | 'games.memory' | 'games.bubbleTrouble' | 'games.tron' | 'games.pokemonBnbMini'
  icon: string
  statusKey: 'gameStatus.ready' | 'gameStatus.comingSoon'
  inspirationKey: 'gameInspiration.orbit' | 'gameInspiration.signal' | 'gameInspiration.memory' | 'gameInspiration.bubbleTrouble' | 'gameInspiration.tron' | 'gameInspiration.pokemonBnbMini'
  page?: 'bubble-trouble' | 'tron' | 'pokemon-bnb'
}
...
export { BubbleTroubleGame, TronGame, PokemonBnbGame }